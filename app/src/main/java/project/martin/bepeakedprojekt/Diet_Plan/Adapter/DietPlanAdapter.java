package project.martin.bepeakedprojekt.Diet_Plan.Adapter;
...
public class DietPlanAdapter extends BaseExpandableListAdapter {
    ...
    public DietPlanAdapter(Context context, ArrayList<GroupInfo> deptList) {
    ...
    public View getGroupView(int groupPosition, boolean isLastChild, View view,
        ...
        if (view == null) {
            ...
            view = inf.inflate(R.layout.items_group_diet_plan, null);
        }
