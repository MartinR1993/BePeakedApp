...
public class ServerTags {
    ...
    protected static final String TAG_CMD_VALIDATE = "validate";
    protected static final String TAG_CMD_GET = "get";
    protected static final String TAG_CMD_SESSION_ID = "session";
