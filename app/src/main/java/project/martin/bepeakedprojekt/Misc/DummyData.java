...
public class DummyData {
    public static final ExerciseElement[] exerciseList = {
            new ExerciseElement(1,"Rear Deltoid Row Dumbbell",
                    ...
                    "7. Repeat.", 11),
            new ExerciseElement(2,"Bench Press",
            ...
            new ExerciseElement(3,"Hammer Grip Incline Bench Press",
            ...
            new ExerciseElement(4,"Dumbbell Incline Bench Press",
            ...
            new ExerciseElement(5,"Incline Shoulder Press Dumbbell",
            ...
            new ExerciseElement(6,"Decline Barbell Bench Press",
                    ...
                    "6. Repeat..", 17),
            new ExerciseElement(7,"Lateral Dumbbell Raises",
                    ...
                    "6. Repeat", 20),
            new ExerciseElement(8,"Lying Leg Curl Machine",
                    ...
                    "4. Repeat.", 22),
            new ExerciseElement(9,"Bicep Curls with Barbell",
            ...
            new ExerciseElement(10,"Tricep Dips using Body Weight",
