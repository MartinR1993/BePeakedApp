...
public class DummyData {
    ...
    public static final WorkoutElement[] workoutList = {
            new WorkoutElement(1, "Bench", new ArrayList<>(Arrays.asList(getExercise(2), getExercise(3), getExercise(4), getExercise(6))), false),
            new WorkoutElement(2, "Dumbell", new ArrayList<>(Arrays.asList(getExercise(1), getExercise(4), getExercise(5), getExercise(7))), false),
            new WorkoutElement(3, "Curl", new ArrayList<>(Arrays.asList(getExercise(8), getExercise(9))), false),
            new WorkoutElement(4, "All", new ArrayList<>(Arrays.asList(exerciseList)), false)
    };
}